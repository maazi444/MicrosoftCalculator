$(document).ready(function()
{
    ...
    btnC.css({"background-color":"#d9dad7", "color":"#000"});
    btnC.text("C");
    btnRow1.append(btnC);
    ...
    btnDivide.css({"background-color":"#d9dad7", "color":"#000"});
    btnDivide.text("/");
    ...
    btnMultiply.css({"background-color":"#d9dad7", "color":"#000"});
    btnMultiply.text("*");
    ...
    btnPlus.css({"background-color":"#d9dad7", "color":"#000","font-size":"20px"});
    btnPlus.text("+");
    btnRow4.append(btnPlus);

    let btnMinus = $("<button>");
    btnMinus.addClass("btnStyle btnValue");
    btnMinus.css({"background-color":"#d9dad7", "color":"#000","font-size":"20px"});
    btnMinus.text("-");
    btnRow4.append(btnMinus);

    let btnEqual = $("<button>");
    btnEqual.addClass("btnStyle");
    btnEqual.css({"background-color":"orange", "color":"#fff","font-size":"20px"});
    btnEqual.text("=");
